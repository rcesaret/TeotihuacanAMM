...
#cols <- c("Civic-Ceremonial Features" = "cyan")
#cols2 <- c("500-meter Rings" = "gray35")
...
map = ggplot() +geom_stars(data = Teo_PopDens)+
  ...
  geom_sf(data = RingsPoly_sf, aes(color=xx), fill=NA, size=1.5) +#, show.legend = TRUE
  ...
  #geom_sf(data = Low_sf, color="white", size=0.75) +
  #geom_sf(data = UncertStat_sf, color="white", size=0.75) +
  #geom_sf(data = IM_sf, color="white", size=0.75) +
  #geom_sf(data = High_sf, color="white", size=0.75) +
