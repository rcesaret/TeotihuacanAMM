...
f5b <- ggplot() +
  ...
  geom_line(data = predict_f5b2, aes(x=PctRow_Area_CCFeat_AoD, y=PctRow_DStrArea_IMUncerStat.p), inetype = "solid", color="darkorange", size=1.3) +
  ...
  geom_line(data = predict_f5b1, aes(x=PctRow_Area_CCFeat_AoD, y=PctRow_DStrArea_IM.p), inetype = "solid", color="yellow3", size=1.3) +
