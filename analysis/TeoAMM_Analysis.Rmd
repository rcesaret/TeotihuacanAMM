...
```{r}
lm_results = RegressionResultsTab(mod, TeoRings, log(TeoRings$PctRow_Area_CCFeat_AoD), TeoRings$PctRow_Area_ArchFeat, model_type="ols", coef="both", residplots=TRUE, residhists=TRUE)
lm_results[[1]]
lm_results[[2]]
lm_results[[3]]
```
